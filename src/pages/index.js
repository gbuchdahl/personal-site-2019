...
const Hero = styled("div")`
    ...
    h1 {
        ...
        a {
            ...
            &:nth-of-type(4) { color: ${colors.orange500}; }
            ...
            &:hover {
                ...
                &:nth-of-type(2) { color: ${colors.green600};  background-color: ${colors.orange200};}
                &:nth-of-type(3) { color: ${colors.purple600};  background-color: ${colors.purple200};}
                &:nth-of-type(4) { color: ${colors.orange600};   background-color: ${colors.green200};}
